...
class AnanasNewProjectWizardDialog : public QWizard
{
    Q_OBJECT

public:
    AnanasNewProjectWizardDialog(QWidget *parent = 0);
    virtual ~AnanasNewProjectWizardDialog();
...
class AnanasNewProjectWizard : public Core::BaseFileWizard
{
    Q_OBJECT

public:
    AnanasNewProjectWizard();
    virtual ~AnanasNewProjectWizard();
