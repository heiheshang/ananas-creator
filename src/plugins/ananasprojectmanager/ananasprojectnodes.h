...
#ifndef ANANASPROJECTNODE_H
#define ANANASPROJECTNODE_H
...
class AnanasProjectNode : public ProjectExplorer::ProjectNode
{
public:
    AnanasProjectNode(AnanasProject *project, Core::IFile *projectFile);
    virtual ~AnanasProjectNode();
...
private:
    ...
    QHash<QString,QString> m_rc;
};

} // namespace Internal
} // namespace AnanasProjectManager

#endif // ANANASPROJECTNODE_H
