...
class AnanasProjectWizardDialog : public QWizard
{
    Q_OBJECT

public:
    AnanasProjectWizardDialog(QWidget *parent = 0);
    virtual ~AnanasProjectWizardDialog();
...
class AnanasProjectWizard : public Core::BaseFileWizard
{
    Q_OBJECT

public:
    AnanasProjectWizard();
    virtual ~AnanasProjectWizard();
