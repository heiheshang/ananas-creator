...
AnanasProjectWizardDialog::~AnanasProjectWizardDialog()
{ }

QString AnanasProjectWizardDialog::path() const
{
    return m_firstPage->path();
}

void AnanasProjectWizardDialog::setPath(const QString &path)
{
    m_firstPage->setPath(path);
}

QString AnanasProjectWizardDialog::projectName() const
{
    return m_firstPage->name();
}

void AnanasProjectWizardDialog::updateFilesView(const QModelIndex &current,
                                                 const QModelIndex &)
{
    if (! current.isValid())
...
void AnanasProjectWizardDialog::initializePage(int id)
{
    Q_UNUSED(id)
}

bool AnanasProjectWizardDialog::validateCurrentPage()
{
    return QWizard::validateCurrentPage();
}

AnanasProjectWizard::AnanasProjectWizard()
...
Core::BaseFileWizardParameters AnanasProjectWizard::parameters()
{
...
QWizard *AnanasProjectWizard::createWizardDialog(QWidget *parent,
                                                  const QString &defaultPath,
                                                  const WizardPageList &extensionPages) const
{
    AnanasProjectWizardDialog *wizard = new AnanasProjectWizardDialog(parent);
    setupWizard(wizard);
...
void AnanasProjectWizard::getFileList(const QDir &dir, const QString &projectRoot,
...
bool AnanasProjectWizard::isValidDir(const QFileInfo &fileInfo) const
{
...
Core::GeneratedFiles AnanasProjectWizard::generateFiles(const QWizard *w,
                                                     QString *errorMessage) const
{
    Q_UNUSED(errorMessage)

    const AnanasProjectWizardDialog *wizard = qobject_cast<const AnanasProjectWizardDialog *>(w);
...
bool AnanasProjectWizard::postGenerateFiles(const Core::GeneratedFiles &l, QString *errorMessage)
{
